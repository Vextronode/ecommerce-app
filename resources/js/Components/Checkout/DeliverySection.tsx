            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                    <div className="flex justify-between items-start mb-2">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-bold bg-[#40E0D0]/20 text-[#245D56] px-2 py-0.5 rounded-full">DIANTAR</span>
                        </div>
                        {selected === 'local_delivery' && <ShieldCheck className="w-5 h-5 text-[#40E0D0]" />}
                    </div>
                    <p className="text-xs text-slate-500 mb-3">Diantar langsung oleh toko</p>
                    <p className="font-bold text-sm text-[#245D56]">
                ...
                >
                    <div className="flex justify-between items-start mb-2">
                        ...
                        {selected === 'self_pickup' && <ShieldCheck className="w-5 h-5 text-[#40E0D0]" />}
                    </div>
                    <p className="text-xs text-slate-500 mb-3">Ambil langsung ke toko</p>
                    <p className="font-bold text-sm text-[#245D56]">Gratis (Rp 0)</p>
                </div>
            </div>
        </section>
    );
