...
export default function TopCategoriesChart({ data }: TopCategoriesChartProps) {
    ...
    return (
        <div className="bg-white p-6 rounded-[20px] border border-[#41B9C5]/20 shadow-sm col-span-1">
            <div aria-label="Action" className="flex justify-between items-center mb-6">
                <h3 className="font-bold text-brand-blue-dark">Top Categories</h3>
                <button aria-label="Opsi Lainnya" className="text-gray-400 hover:text-gray-600">
